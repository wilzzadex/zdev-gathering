@extends('back.master')
@section('judul')
    Sewa Event Gathering / Edit Planning Gathering
@endsection
@section('custom-css')
        ...
        <div class="col-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('event.update',$event->id) }}" id="userAdd" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>Nama Klien
                                <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" value="{{ $event->nama_klien }}" name="nama" required placeholder="Nama Klien..." />
                        </div>
                        <div class="form-group">
                            <label>Tanggal Acara
                                <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="lokasi_id" required class="form-control" id="lokasi_id">
                                    ...
                                    @foreach ($lokasi as $item)
                                        <option data-harga="{{ $item->harga }}" {{ $item->id == $event->lokasi_id ? 'selected' : '' }} value="{{ $item->id }}">
                                            {{ $item->nama }} |
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <label>MC
                                    <span class="text-danger">*</span></label>
                                <input type="text" required class="form-control" value="{{ $event->mc }}" name="mc" placeholder="MC..." />
                            </div>
                            <div class="col-md-6">
                                <label>Harga
                                    <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="mc_harga" value="{{ number_format($event->harga_mc,0,',','.') }}" onkeyup="hitungTotal(this)"
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <label>Band / Musik
                                    <span class="text-danger">*</span></label>
                                <input type="text" required class="form-control" value="{{ $event->band }}" name="band" placeholder="Band/Musik..." />
                            </div>
                            <div class="col-md-6">
                                <label>Harga
                                    <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label>Harga Makanan/porsi
                                    <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" value="{{ number_format($event->makanan_per_porsi,0,',','.') }}" required id="makanan_harga" name="makanan_per"
                                    value="0" placeholder="Band/Musik..." />
                            </div>
                            <div class="col-md-4">
                                <label>Jumlah Porsi
                                    <span class="text-danger">*</span></label>
                                <input type="number" value="{{ $event->jml_porsi }}" min="0" class="form-control" required value="0"
                            ...
                            <div class="col-md-4">
                                <label>Total Harga
                                    <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" required name="total_makanan"
                                    id="total_makanan" value="{{ number_format($event->biaya_makanan,0,',','.') }}" readonly placeholder="Harga Untuk Makanan..." />
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Total Budget
                                <span class="text-danger">*</span></label>
                            <input type="text" id="total_budget" value="{{ number_format($event->total_budget,0,',','.') }}" readonly class="form-control" required value="0"
                                name="total_budget" readonly placeholder="Harga Untuk Makanan..." />
                        </div>
                        <div class="form-group">
                            <label>Status <span class="text-danger">*</span></label>
                            <select name="status" class="form-control">
                                <option value="menunggu-pembayaran" {{ $event->status == 'menunggu-pembayaran' ? 'selected' : '' }}>Menunggu Pembayaran</option>
                                <option value="lunas" {{ $event->status == 'lunas' ? 'selected' : '' }}>Lunas</option>
                            </select>
                        </div>
                                        ...
                                        <td class="validate">
                                            <label class="btn btn-raised btn-default btn-sm"
                                                style="color: white; width: 180px; background:grey; height: 30px;"> <i
                                                    class="fa fa-picture-o"></i> Pilih Gambar<input type="file"
